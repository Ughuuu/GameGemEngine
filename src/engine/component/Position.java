...
public class Position extends Component {
     ...
     */
    @Inject
    public Position(ComponentSystem componentSystem) {
     ...
     */
    public Position setRelativeQuaternion(Quaternion rotation) {
     ...
     * @return This object for chaining.
     */
    public Position setRelativeRotation(Vector3 rotation) {
     ...
     * @return This object for chaining.
     */
    public Position setRelativeScale(float scale) {
     ...
     * @return This object for chaining.
     */
    public Position setRelativeScale(Vector3 scale) {
     ...
     * @return This object for chaining.
     */
    public Position setRelativePosition(Vector3 position) {
    ...
    private void recalculateFromParent() {
    	Entity owner = componentSystem.getOwner(this.getId());
